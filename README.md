...
- Auto feature selection — drops id-like/constant columns, keeps continuous features
- Elbow method + silhouette score to suggest the best `k`
- Fully standardized clustering, so datasets with **any number of features** are
  segmented correctly regardless of feature scale
