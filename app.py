...
section_header("2 · Results")

if excluded:
    st.caption(
        f"Auto features: {', '.join(features_used)} "
        f"· K = {pipeline['k']} (best silhouette) · "
...
with m2:
    ...
    st.markdown(
        ...
        <div style="padding-top:16px; color:#6b7280; font-size:0.9rem;">
            Features and the number of clusters are chosen
            automatically by the model. Values close to <b>1</b> mean
